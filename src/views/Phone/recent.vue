  ...
  <div class="screen" ref="screen">
    <div class="header" :class="{ active: isScrolled }">
      <div class="header__group">
        <div class="header__group-title">Недавние</div>
    ...
    <div class="calls">
      <div class="call" v-for="call in getCalls" :key="call.id">
        <div class="call__avatar">
          <img src="@/assets/img/no-avatar.svg" alt="" />
        </div>

        <div class="call__info" :class="call.type" @click="callToNumber(call)">
          <div class="call__info-sender">{{ call.number }}</div>
          <div class="call__info-text">{{ call.country }}</div>
        </div>

        <div class="call__date">
          <span>{{ dateToTime(call.date) }}</span>
        </div>
        ...
        <div class="call__actions">
          <div class="btn">
            ...
            >
              <path
                d="M8 3.625V12.375M3.625 8H12.375"
                stroke="#0A83FB"
                stroke-width="1.25"
                stroke-linecap="round"
                stroke-linejoin="round"
      ...
      calls: [
        {
          ...
          country: "Россия",
          date: new Date("2025-01-24T12:00:00"),
          type: "missed",
        },
        {
          id: 1,
          number: "+7 (322) 999-99-99",
          country: "Россия",
          date: new Date("2025-01-24T12:00:00"),
          type: "incoming",
        },
  ...
  computed: {
    getCalls() {
      return this.calls.filter((call) => {
        return call.number.toLowerCase().includes(this.search.toLowerCase());
      });
    },
    dateToTime() {
      return dateToTime;
